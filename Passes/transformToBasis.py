...
# The code of pass UnitarySynthesis was modified and adapted to the needs in context of the thesis creation
...
class transformToBasis(TransformationPass):
    """Transform gates to their basis gates."""
    ...
    def run(self, dag: DAGCircuit) -> DAGCircuit:
        ...
        # Decompose every gate in circuit
