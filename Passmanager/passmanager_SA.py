...
from Passes.partitioning import SelectUnitaryBlocks
...
def testing_pass_manager( probabilities, logFile, initTemp=15, minTemp=0.5, n=0.3, singleIt=False, alpha = 0.9) -> PassManager:  
    ...
    _select_blocks = [SelectUnitaryBlocks(probabilities, alpha, initTemp, minTemp, n=n)]
    ...
    _one_qubit_opt = [Optimize1qGatesDecomposition(basis_gates)] 
    
    # Build pass manager
    pm = PassManager()
    pm.append(_evaluation + _to_basis + _evaluation)
